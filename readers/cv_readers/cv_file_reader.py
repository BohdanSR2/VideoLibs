...
class CvFileReader(CvReaderABC):
    """
    CvFileReader class
    """
    ...
    def __del__(self):
        ...
        self._logger.debug('CV file reader is stopped')
    ...
    def _init_capture(self) -> None:
        ...
        self._logger.debug('Opening capture..')
        if not self._capture.isOpened():
            return self._logger.debug(f'Failed to open {self.path}')
